...
So in EAX must bo stored the value of the syscall (0x5), in EBX must be stored the adrress of the pathname and in ECX in must be stored the permissions ```r-x``` (0x401)
