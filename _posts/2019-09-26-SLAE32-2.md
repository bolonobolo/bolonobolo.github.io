...
This is also the second assignment from Viviek Ramachandran's SLAE32 course.<br>
...
if __name__ == '__main__':
        main()
```
It prints in green the hexdecimal big endian string of IP and port number and inject the vales in our shellcode.<br>
