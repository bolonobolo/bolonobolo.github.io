...
int 0x80 
```
Test it and see the length, 91 bytes! 1 byte less then original.<br>
...
The 74 bytes Adduser Shellcode is published on [Exploit-DB](https://www.exploit-db.com/exploits/47511)<br>
<br>
