...
In the [next post](https://blackcloud.me/sharing-is-caring/) we'll try to complete another point of the assignment ```Build a dropper, which hosts its payload in a separate AES-encrypted file```.
