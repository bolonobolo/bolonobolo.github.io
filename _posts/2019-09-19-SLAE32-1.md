...
Now we can extract the hexadecimal value of the shellcode with an esotheric objdump picked up from [CommandLineFu](https://www.commandlinefu.com/commands/view/6051/get-all-shellcode-on-binary-file-from-objdump).
```bash
...
""
...
```bash
gcc -fno-stack-protector -z execstack ../shellcode/shellcode.c -o ../shellcode/shellcode
```
