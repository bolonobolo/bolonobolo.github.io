...
It works like a charm, so now we can extract the hexadecimal value of the shellcode with an esotheric objdump picked up from [CommandLineFu](https://www.commandlinefu.com/commands/view/6051/get-all-shellcode-on-binary-file-from-objdump).
```bash
...
""
