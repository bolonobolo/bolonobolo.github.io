...
and [here](https://github.com/bolonobolo/av_evasion/blob/master/PE_Injection/AES encrypted Dropper/implant.cpp) you can find the obfuscated dropper code. <br>
