---
layout: single
title: AV Evasion - The payload is behind an image
date: 2020-06-22
classes: wide
header:
...
## Introduction
Hello and welcome back to the 2nd assignment of the well done course on Malware Development by [Sektor7](https://institute.sektor7.net/red-team-operator-malware-development-essentials), in the previos [blog post](https://blackcloud.me/av-evasion-1/) we talked about PE injection using a payload saved as a favicon.ico file, with all the functions and payload encrypted with AES. The next assignment is to hide the payload inside an image and implement the dropper with the capacity of extraction of the payload and injecting it in the PE process target.
...
- Take a kitties image from internet (who don't love kitties? :))
...
![](/assets/images/AV_evasion/AVG_image_bypass.gif)](/assets/images/AV_evasion/AVG_bypass.webm)<br>

and [here](https://github.com/bolonobolo/av_evasion/blob/master/PE_Injection/implant.cpp) you can find the dropper code. <br>
