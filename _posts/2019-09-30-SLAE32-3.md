...
3. compare the return code <br>
if ZF is set jump to the next memory PAGE SIZE because it is a invalid memory address<br>
or compare the value with the egg
4. if the comparison doesn't match step into the next address and repeat from point 2<br>
5. if ZF is set, egg found, execute our shellcode
