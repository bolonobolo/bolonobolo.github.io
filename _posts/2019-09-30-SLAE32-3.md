...
```
As you can see, we must add the hunter hexadecimal code and the egg 2 times before the reverse shellcode developed in the [previous post](https://bolonobolo.github.io/SLAE32-2/), now let's see if it works
